class WelcomeController < ApplicationController
  ...
  def index
  	@slider_categories = [
  		...
  		{image: 'assets/Protection-2.jpg',title: 'acc cover + extra' , description: 'Our website has changed, but our commitment to you never will.', url: '#'},
  		...
  		{image: 'assets/Music Carnival.jpg',title: 'win a trip to fiji' , description: 'Our website has changed, but our commitment to you never will.', url: '#'}
  	]
  end
